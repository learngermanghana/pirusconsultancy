...
const fallbackProducts: SedifexProduct[] = [
  {
    id: "consult-1",
    title: "Pathway Clarity Session",
    description: "One-on-one consultation to map your Germany or Europe relocation route.",
    ctaLabel: "Book Consultation",
  },
  {
    id: "consult-2",
    title: "Admission & Document Review",
    description: "Structured support for SOP, CV, school choices, and application checks.",
    ctaLabel: "Get Started",
  },
  {
    id: "consult-3",
    title: "Visa Readiness Package",
    description: "Document quality checks, interview prep, and pre-departure guidance.",
...
const fallbackGallery: SedifexGalleryItem[] = [
  {
    id: "story-1",
    title: "Master's admission in Germany",
    caption: "Received structured support from profile review to visa prep.",
  },
  {
    id: "story-2",
    title: "Ausbildung pathway success",
    caption: "Clear process and timely coaching helped secure the route.",
  },
  {
    id: "story-3",
    title: "European study option",
    caption: "Switched to an alternative Europe pathway with transparent guidance.",
  },
];
...
function normalizePromo(payload: unknown): SedifexPromo | null {
  ...
  return {
    ...
    description: String(data.description ?? data.summary ?? "Limited-time relocation support campaign."),
    ctaLabel: String(data.ctaLabel ?? data.buttonText ?? "Claim Offer"),
  };
}
